package com.ian.commons.report.excel;

import com.ian.commons.utils.StringUtils;
	...
	public <T> List<T> parse(Class<T> clazz) {
		...
		try {
			...
			if (null != sheet) {
				...
				Map<String, ExcelFiledInfo> infoMap = new HashMap<String, ExcelFiledInfo>(16);
				...
				Map<String, String> titleMap = new HashMap<String, String>(16);
				for (Cell title : row) {
