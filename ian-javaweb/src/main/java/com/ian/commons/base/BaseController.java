package com.ian.commons.base;

import com.ian.commons.result.PageInfo;
import com.ian.commons.result.Result;
import com.ian.commons.shiro.ShiroUser;
import com.ian.commons.utils.Charsets;
import com.ian.commons.utils.JsonObject;
import com.ian.commons.utils.StringEscapeEditor;
import com.ian.commons.utils.URLUtils;
...
public abstract class BaseController {
	 ...
	 * @return
	 */
	public Object renderResult(String message) {
	 ...
	 * @return
	 */
	public Object renderResult(String message, String resultCode) {
		JsonObject jsonObject = new JsonObject();
		jsonObject.setMessage( message );
		jsonObject.setResultCode( resultCode );
		return jsonObject;
	}
	 ...
	 * @return
	 */
	public Object renderResult(String message, Object data, String resultCode) {
		JsonObject jsonObject = new JsonObject();
		jsonObject.setMessage( message );
