...
public class ZXingCode {
	...
	public static String getLogoQRCode(String qrUrl, String productName) {
		...
		// TODO 本地路径
		//		String filePath = "/Users/ian/Idea-workspace/bobowebserver/BOBO/src/main/webapp/static/code/logo.png";

		// TODO 服务器路径
		String filePath = "/usr/local/tomcat8/webapps/BOBO/static/code/logo.png";
	...
	public String addLogo_QRCode(BufferedImage bim, File logoPic, LogoConfig logoConfig, String productName) {
		try {
			...
			//					"/Users/ian/Idea-workspace/bobowebserver/BOBO/src/main/webapp/static/code/BOBO-" + System.currentTimeMillis() + ".png" ) );

			// TODO 服务器路径
			ImageIO.write( image, "png", new File( "/usr/local/tomcat8/webapps/BOBO/static/code/BOBO-" + System.currentTimeMillis() + ".png" ) );
